...
- name: golang
  wasm:
    url: https://github.com/vtuanjs/sqlc-gen-go/releases/download/v2.1.0-stable/sqlc-gen-go.wasm
    sha256: 18bea654a3a8ad822d5e46e7a8553ec55f11043f5b23befbdd6b88786c45abc0
sql:
- schema: schema.sql
  queries: query.sql
  engine: postgresql
