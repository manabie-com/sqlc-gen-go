...
- name: golang
  wasm:
    url: https://github.com/vtuanjs/sqlc-gen-go/releases/download/v2.5.0/sqlc-gen-go.wasm
    sha256: 22ff409d72b41992d9dd9bb1ff132b9132a6c1b41c9a0a10afbaacab1f94445b
sql:
- schema: schema.sql
  queries: query.sql
  engine: postgresql
